...
const workspace = await mkdtemp(path.join(tmpdir(), 'code-review-tracker-integration-'));
const userData = await mkdtemp(path.join(tmpdir(), 'code-review-tracker-user-data-'));
try {
